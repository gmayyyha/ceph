...
#pragma GCC diagnostic pop
  ...
  */
  ...
  int Image::diff_iterate4(const char *fromsnapname, uint64_t ofs, uint64_t len,
                           ...
                           int (*cb)(uint64_t, size_t, int, void *), void *arg)
  {
    ...
    int r = librbd::api::DiffIterate<>::diff_iterate2(ictx, from_snap_id,
                                                     ofs, len, include_parent,
                                                     whole_object, fast, cb, arg);
    tracepoint(librbd, diff_iterate_exit, r);
    return r;
  }
  ...
  int Image::diff_iterate2(const char *fromsnapname, uint64_t ofs, uint64_t len,
                           ...
                           int (*cb)(uint64_t, size_t, int, void *), void *arg)
  {
    return diff_iterate4(fromsnapname, ofs, len, include_parent, whole_object, false, cb, arg);
  }
...
extern "C" int rbd_diff_iterate4(rbd_image_t image, const char *fromsnapname,
                                uint64_t ofs, uint64_t len,
                                uint8_t include_parent, uint8_t whole_object,
				bool fast,
                                int (*cb)(uint64_t, size_t, int, void *),
